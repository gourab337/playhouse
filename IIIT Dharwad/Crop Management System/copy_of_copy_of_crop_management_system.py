# -*- coding: utf-8 -*-
"""Copy of Copy of Crop_Management_System.ipynb
...
#class Productivity_Details:
  def TokenCheck(token):
    ...
    if(Login.token == 1): # and (Login.AdminAccess == False)):
      ...
      columns_titles = ["Crop_Year","Crop","State_Name","District_Name","Season","Production","Area"]
      cropdata=cropdata.reindex(columns=columns_titles)
      answ = input("Do you want to see the full data?")
      ...
      if ans == 'yes':
        ...
        print(cropdata.loc[
                  (cropdata['State_Name'] == state) & (cropdata['Crop'] == crop) & (cropdata['Crop_Year'] == year)][
                  'District_Name'])
        district = input("Enter the district name: ")
        print('This is the amount of production of ' + crop + ' in the year ' + str(
            year) + ' in ' + state + ', ' + district)
        print(cropdata.loc[(cropdata['District_Name'] == district) & (cropdata['State_Name'] == state) & (
                    cropdata['Crop'] == crop) & (cropdata['Crop_Year'] == year)])
...
if(response == 1):
      ...
      if ans == 'yes':
            ...
            district = input("Enter the district name: ")
            print('This is the amount of production of ' + crop + ' in the year ' + str(year) + ' in ' + state + ', ' + district)
